...
public class GwtJsplumb implements EntryPoint {
	    ...
	    AbstractMediator window1 = new AbstractMediator("im optional widget");
        ...
        private ImageResource StoreImageResource = JsClientBundle.INSTANCE.StoreImage();
        ...
        public void onModuleLoad() {
                ...
                window1.setImage(StoreImageResource);
    	...
    	private void injectScript() {
    		...
    		ScriptInjector.fromString(JsClientBundle.INSTANCE.gwtdemoSource().getText())
    				.setWindow(ScriptInjector.TOP_WINDOW).inject();
